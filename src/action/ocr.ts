...
**📄 E-Way Bill, Challan/Invoice Number, Vehicle Number, and GST Number Extraction Prompt (For PDF)**
...
* Often found **near the E-Way Bill Number** or "Generated By".
...
* Usually appears near:
  ...
  * \`Generated By: \`, \`Entered By: \`, or \`Supplier GSTIN: \`
  * Look for labels like \`GSTIN\`, \`GST No\`, or \`GST Number\`.
